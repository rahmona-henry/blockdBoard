...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Lists = __webpack_require__(168);
	...
	var Form = function (_Component) {
	  ...
	  _createClass(Form, [{
	    ...
	    value: function postData(e) {
	      //e.preventDefault();
	      _superagent2.default.post('http://localhost:3000/').send({ name: (0, _jquery2.default)("input[name='name']").val(), question: (0, _jquery2.default)("textarea[name='question']").val() });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'large-6 columns', action: 'http://localhost:3000/', method: 'post', type: 'multipart/form-data' },
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { type: 'submit', name: 'add', value: 'Submit', id: 'submit' })
	        )
	      );
	    }
	  }]);
